...
### Id
The Id module is responsible for handling user authentication and Single Sign-On (SSO). Docmix integrates Keycloak, a widely-used identity and access management solution, to provide secure login flows, role-based access control, and centralized user management.
